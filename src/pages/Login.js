...
function Login() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        let loginData = await axios.post("https://localhost:3001/login", values)
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form className="mx-1 mx-md-4" onSubmit={formik.handleSubmit}>
                        ...
                        <div className="d-flex justify-content-left mx-3 mb-lg-4">
                          <button type="submit" className="btn btn-primary btn-md mb-4">Login</button>
                        </div>
                        <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                          <Link to={"/register"}>
                          <label className='mb-3' style={{ marginLeft: "30px", textAlign: "center", padding: "5px" }}><h6>Dont have an account ? - Register </h6></label>
                          </Link>
